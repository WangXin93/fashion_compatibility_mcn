...
def prepare_dataloaders(root_dir="../data/images/", data_dir="../data/", batch_size=16, img_size=224, use_mean_img=True, neg_samples=True, num_workers=4, collate_fn=collate_fn):
